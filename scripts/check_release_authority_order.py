...
EXPECTED_ORDERING = {
    ...
    "release_build": "public_product_repository_builds_linux_signed_android_and_rooted_phone_runtime_from_final_tag_target",
...
EXPECTED_MANIFEST = {
    ...
    "phone_runtime_component_contract": "contracts/operations/phone-production-release-components-v1.json",
}
EXPECTED_DIGEST_SET = {
    "format_version": 1,
...
def check_repository(root: Path) -> list[str]:
    ...
    _require_tokens(
        ...
        (
            ...
            "Rooted phone runtime asset included: true",
    ...
    _require_tokens(
        ...
        (
            ...
            "phone-production-release-components-v1.json",
            "exact bytes",
