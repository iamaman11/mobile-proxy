...
EXPECTED_HANDOFF_TRANSPORT = {
    "mechanism": "private_repository_actions_secret_envelope_plus_non_secret_workflow_dispatch",
    "private_secret_name": "ITEM20_SESSION_ENVELOPE",
    ...
    "required_private_repository_permissions": ["Actions: write", "Secrets: write"],
    "private_dispatch_inputs": ["candidate_sha", "control_plane_sha", "session_nonce"],
    "endpoint_in_dispatch_inputs": False,
    "provider_uuid_in_envelope": False,
    "public_persistence": "forbidden",
    "private_secret_encryption": "github_actions_repository_public_key_libsodium",
    "private_secret_lifetime": "single_serialized_item20_session_only",
    "dispatch_run_correlation": "fresh_session_nonce_without_endpoint_or_provider_identity",
}
EXPECTED_HANDOFF_ENVELOPE = {
    "format_version": 1,
    "fields": ["candidate_sha", "control_plane_sha", "session_nonce", "transport_endpoint"],
...
EXPECTED_HANDOFF_CRASH_RECOVERY = {
    ...
    "no_active_prior_private_session_before_new_write": True,
    "stale_secret_cleanup_before_replacement": True,
    "private_secret_delete_after_terminal_private_run": True,
    "private_secret_absence_must_be_confirmed": True,
    "provider_cleanup_runs_even_if_handoff_cleanup_fails": True,
    "acceptance_success_requires_private_secret_absence": True,
...
EXPECTED_HANDOFF_EVIDENCE = {
    ...
    "private_endpoint_evidence_recording": False,
...
EXPECTED_HANDOFF_FORBIDDEN = [
    ...
    "endpoint_in_workflow_dispatch_input",
